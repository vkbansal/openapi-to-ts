...
export interface UseActionsGetWorkflowUsageQueryPathParams {
	owner: string;
	repo: string;
	workflow_id: number & string;
}

export interface UseActionsGetWorkflowUsageQueryProps
	extends UseActionsGetWorkflowUsageQueryPathParams {}
