...
export interface UseSecretScanningGetAlertQueryPathParams {
	owner: string;
	repo: string;
	alert_number: AlertNumber;
}

export interface UseSecretScanningGetAlertQueryProps
	extends UseSecretScanningGetAlertQueryPathParams {}
