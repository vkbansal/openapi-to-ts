...
export interface UseChecksUpdateMutationPathParams {
	owner: string;
	repo: string;
	check_run_id: number;
}

export interface UseChecksUpdateMutationRequestBody {
	/**
...
export interface UseChecksUpdateMutationProps extends UseChecksUpdateMutationPathParams {
	body: UseChecksUpdateMutationRequestBody;
}
...
export function useChecksUpdateMutation(props: UseChecksUpdateMutationProps) {
