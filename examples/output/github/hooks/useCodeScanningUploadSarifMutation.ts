...
export interface UseCodeScanningUploadSarifMutationPathParams {
	owner: string;
	repo: string;
}

export interface UseCodeScanningUploadSarifMutationRequestBody {
	/**
...
export interface UseCodeScanningUploadSarifMutationProps
	extends UseCodeScanningUploadSarifMutationPathParams {
	body: UseCodeScanningUploadSarifMutationRequestBody;
}
...
export function useCodeScanningUploadSarifMutation(props: UseCodeScanningUploadSarifMutationProps) {
