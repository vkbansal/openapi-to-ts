...
export interface UseChecksCreateMutationPathParams {
	owner: string;
	repo: string;
}

export interface UseChecksCreateMutationRequestBody {
	/**
...
export interface UseChecksCreateMutationProps extends UseChecksCreateMutationPathParams {
	body: UseChecksCreateMutationRequestBody;
}
...
export function useChecksCreateMutation(props: UseChecksCreateMutationProps) {
