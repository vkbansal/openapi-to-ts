...
export interface MigrationsGetStatusForAuthenticatedUserProps
	...
	paramsSerializer?: (params: MigrationsGetStatusForAuthenticatedUserQueryParams) => string;
}
...
export async function migrationsGetStatusForAuthenticatedUser(
	...
	return _fetcher<unknown, MigrationsGetStatusForAuthenticatedUserQueryParams, unknown>({
