...
export interface EnterpriseAdminListProvisionedIdentitiesEnterpriseProps
	...
	paramsSerializer?: (
		params: EnterpriseAdminListProvisionedIdentitiesEnterpriseQueryParams,
	) => string;
}
...
export async function enterpriseAdminListProvisionedIdentitiesEnterprise(
	...
	return _fetcher<unknown, EnterpriseAdminListProvisionedIdentitiesEnterpriseQueryParams, unknown>({
