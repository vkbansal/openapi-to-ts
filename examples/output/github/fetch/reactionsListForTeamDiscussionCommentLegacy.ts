...
export interface ReactionsListForTeamDiscussionCommentLegacyProps
	...
	paramsSerializer?: (params: ReactionsListForTeamDiscussionCommentLegacyQueryParams) => string;
}
...
export async function reactionsListForTeamDiscussionCommentLegacy(
	...
	return _fetcher<unknown, ReactionsListForTeamDiscussionCommentLegacyQueryParams, unknown>({
