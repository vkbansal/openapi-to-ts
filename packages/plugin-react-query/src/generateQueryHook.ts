...
export function generateQueryHook(
	...
	// const queryParams = codegen.createQueryParamsInterface(operation.operationId, params.query);
	// const pathParams = codegen.createPathParamsInterface(operation.operationId, params.path);
